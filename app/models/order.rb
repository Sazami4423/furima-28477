class Order
  ...
  Address.create(postal_code: postal_code, prefectures_id: prefectures_id, municipalities: municipalities, address: address, building_name: building_name, tel: tel, product_purchase_management_id: product_purchase_management.id)
  end
end