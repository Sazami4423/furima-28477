...
ActiveRecord::Schema.define(version: 2021_03_14_120135) do
  ...
  create_table "product_purchase_managements", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_id"], name: "index_product_purchase_managements_on_product_id"
    t.index ["user_id"], name: "index_product_purchase_managements_on_user_id"
  end
